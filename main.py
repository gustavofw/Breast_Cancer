...
# Para utilizar este código, é necessário adicionar o arquivo BreastCancer.csv a pasta Content.
# Quando rodar o código, alguns arquivos em PNG serão gerados, estes são os gráficos correspondentes a pesquisa.
import pandas as pd
import matplotlib.pyplot as plt
import seaborn as sns
from sklearn.decomposition import PCA
...
df.to_csv('BreastCancer_Tratado.csv', index=False)